# This code generates simulated background and Cosine signal for a mock dark matter experiment
# and tests for both a cosine model and constant background and calculates frequentist p-value, 
# AIC, BIC. Bayes factor calculation in a different script
...
y1=y[0:110]
err1=erry[0:110]
# for full 5 year results use below else replace t,y,err with t1,y1,err1
results(t,y,erry)
